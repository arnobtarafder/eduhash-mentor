...
const Footer = () => {
    ...
    return (
        <footer className='bg-color py-3 mb-0 footer-section'>
          ...
          <a
            href='https://facebook.com/arnob.tarafder.2058'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200 pe-2'
          >
            <svg
              width='20'
              height='20'
          ...
          <a
            href='https://twitter.com/arnobtarafder'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200 pe-2'
          >
            <svg
              width='20'
