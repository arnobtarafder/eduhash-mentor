            ...
            <div className="row g-0">
                ...
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <h6 className="card-title text-center fw-light">Student, Engineering University School and College (EUSC)</h6><hr />

                        <p className="card-text mt-5 px-3 fw-lighter"> Hi <span><img style={{height: "25px"}} src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/72/facebook/65/waving-hand-sign_1f44b.png" alt="" /></span> I am Arnob. I would love to say the truth about myself. I think, I am still in a flow and going with course without any problem just because of the facebook group which is made for batch-5 by programming hero authority and a messenger group which is made by a student to solve problems together and discuss about programming. <br /><br />
